    ...
    function loadPlaylists() {
        ...
        firebase.database().ref('playlists').once('value').then(function(snapshot) {
            ...
            if (isMahapack) {
                ...
                if (playlistMeta) {
                    playlistMeta.textContent = '📦 MAHAPACK · Class: ' + (playlist.class || '-') + ' · Price: ₹' + (playlist.price || '-') + ' · Author: ' + (playlist.author || 'Akash Ascent') + ' · Included Playlists: ' + includedIds.length;
                }
                ...
                if (playlistMeta) {
                    playlistMeta.textContent = 'Author: ' + (playlist.author || 'Akash Ascent Team') + ' · Class: ' + (playlist.class || playlist.courseClass || '-') + ' · Price: ₹' + (playlist.price || playlist.cost || '-') + ' · Playlist ID: ' + selectedPlaylistId;
                }
